                                                ...
                                                <div class="container">
                                                    ...
                                                    <div class="off_canvas_section">
                                                        ...
                                                        <div class="offcanvas w-75 offcanvas-end" data-bs-scroll="true"
                                                            tabindex="-1" id="offcanvasAddEmployee"
                                                            aria-labelledby="offcanvasExampleLabel">
                                                            <div class="offcanvas-header">
                                                                <h5 class="offcanvas-title" id="offcanvasExampleLabel">
                                                                    Add Employee Details
                                                                            ...
                                                                            <div class=" ">
                                                                                <form action="" method="post">
                                                                                    <div class="row">
                                                                                        <div class="mb-3">
                                                                                            <label
                                                                                                for="add_employee_name">Employee
                                                                                                name</label>
                                                                                            <input type="text"
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <label
                                                                                                for="add_employee_age">Age</label>
                                                                                            <input type="text"
                                                                                                id="add_employee_age"
                                                                                                name="add_employee_age"
                                                                                                class="form-control mt-2">
                                                                                        </div>
                                                                                        <div
                                                                                            class="mb-3 col-md-6 col-sm-12 ">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <button type="submit" onclick="add_employee(event)" class="btn btn-primary mt-4">Add Employee</button>
